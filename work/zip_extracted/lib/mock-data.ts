...
export const trades: Trade[] = [
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-05T11:20:00Z', 97500, '价格站稳前高，止损上移至成本上方'],
    ],
    tags: ['突破回踩', 'A+ 形态'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-07T06:00:00Z', 98700, 'TP1 前止损上移到保本'],
      ['tp-set', '2026-01-07T02:15:00Z', 99680, 'TP1'],
      ['tp-move', '2026-01-07T07:10:00Z', 100420, '剩余仓位目标上移至整数关口'],
    ],
    tags: ['分批止盈', '加仓'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-12T10:20:00Z', 3320, 'TP1 后推保本'],
    ],
    tags: ['趋势跟随', '分批止盈'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-14T11:15:00Z', 99320, 'TP1 后推保本'],
      ['sl-move', '2026-01-14T13:30:00Z', 98700, '跟随 EMA20 下移'],
    ],
    tags: ['趋势跟随', '分批止盈', 'A+ 形态'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-20T06:00:00Z', 96800, '突破加仓后整体止损上移'],
      ['sl-move', '2026-01-20T09:25:00Z', 97620, 'TP1 后改为移动止损'],
    ],
    tags: ['加仓', '移动止损'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-26T12:00:00Z', 98460, '推保本'],
    ],
    tags: ['突破回踩', 'A+ 形态'],
  }),
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-29T11:40:00Z', 3430, 'TP1 后推保本'],
    ],
    tags: ['分批止盈'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2025-08-07T20:00:00Z', 62150, '推保本过夜'],
    ],
    tags: ['区间交易', 'A+ 形态'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2025-08-12T14:10:00Z', 60240, 'TP1 后推保本'],
    ],
    tags: ['区间交易', '分批止盈'],
  }),
  makeTrade({
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2025-08-22T13:30:00Z', 62680, 'TP1 后推保本'],
      ['sl-move', '2025-08-22T22:00:00Z', 63500, '跟随结构低点上移'],
    ],
    tags: ['突破回踩', '分批止盈', 'A+ 形态'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-06T16:00:00Z', 6095, '推保本'],
    ],
    tags: ['开盘区间突破'],
  ...
  makeTrade({
    ...
    events: [
      ...
      ['sl-move', '2026-01-21T17:30:00Z', 6145, '整体推至成本附近'],
    ],
    tags: ['趋势跟随', '加仓'],
    referenceImages: ['/images/ref-chart-1.png'],
  }),
