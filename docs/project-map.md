...
| Frontend unit tests (vitest) | `lib/bar-time.test.ts`, `lib/execution-display.test.ts`, `lib/process-score.test.ts`, `lib/case-summary.test.ts`, `lib/format.test.ts`, `lib/metrics.test.ts` (`pnpm test`) |
